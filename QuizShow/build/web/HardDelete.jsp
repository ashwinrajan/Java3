...
<%
	...
	String getCount = "SELECT COUNT(Question) FROM HardQuestions";
	...
	String query = "SELECT * FROM HardQuestions";
...
<br/>
<br/>
<a href="HardPrevious.jsp"> Previous </a>  &nbsp  <a href="HardForward.jsp" >Forward </a>
<br/>
<br/>
<a href="DeleteHardQuestion.jsp">Delete This Question</a>
<br/>
<br/>
