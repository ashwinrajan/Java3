...
<html>
    ...
    <body style="background-image:url('Images/final.jpg')">
        ...
        <form name="form" method="post" action="http://localhost:8080/PizzaManagement/Userlogin" onsubmit="javascript:return validate();"> 
            ...
            <div style="margin: auto; width:260px; height:140px; border:2px solid black; padding:25px">
                ...
                <table>
                    <tr>
                    <center><b>User Login</b></center><br> 
                    <td>
                        <b> Username:</b> <br/>
                    </td>
                    <td>
                ...
                <img src="Images/adminButton.png" 
                     ...
                     onmouseout="this.src='Images/adminButton.png';" onClick="parent.location='adminAccess.jsp'"/></button>
